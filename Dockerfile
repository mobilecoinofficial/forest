...
RUN git pull origin forest-fork-v1.1.2-payments
...
COPY ./mc_util/ ./payments_monitor.py ./utils.py ./teli.py ./avatar.png ./datastore.py ./forest_tables.py ./fuse.py  ./mem.py  ./pghelp.py ./main.py /app/ 
