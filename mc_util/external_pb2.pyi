...
class ViewKey(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["spend_public_key",b"spend_public_key","view_private_key",b"view_private_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["spend_public_key",b"spend_public_key","view_private_key",b"view_private_key"]) -> None: ...
...
class Amount(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["commitment",b"commitment","masked_value",b"masked_value"]) -> None: ...
...
class TxOut(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["amount",b"amount","e_fog_hint",b"e_fog_hint","e_memo",b"e_memo","public_key",b"public_key","target_key",b"target_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["amount",b"amount","e_fog_hint",b"e_fog_hint","e_memo",b"e_memo","public_key",b"public_key","target_key",b"target_key"]) -> None: ...
...
class TxIn(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["proofs",b"proofs","ring",b"ring"]) -> None: ...
global___TxIn = TxIn
...
class TxPrefix(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["fee",b"fee","inputs",b"inputs","outputs",b"outputs","tombstone_block",b"tombstone_block"]) -> None: ...
...
class SignatureRctBulletproofs(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["pseudo_output_commitments",b"pseudo_output_commitments","range_proofs",b"range_proofs","ring_signatures",b"ring_signatures"]) -> None: ...
...
class Receipt(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["amount",b"amount","confirmation",b"confirmation","public_key",b"public_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["amount",b"amount","confirmation",b"confirmation","public_key",b"public_key","tombstone_block",b"tombstone_block"]) -> None: ...
